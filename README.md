...
I'm a creative problem solving enthusiast, enjoy working with  `TypeScript`, `Node.JS` , `Python`, `Express`, `GraphQL`, `React`, `React Native` , `Android (Java - Kotlin)`. Experience with `Laravel`.
